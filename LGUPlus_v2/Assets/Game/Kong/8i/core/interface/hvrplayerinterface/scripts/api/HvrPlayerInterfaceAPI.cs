...
namespace HVR.Interface
{
    public static class HvrPlayerInterfaceAPI
    {
        ...
        [DllImport(DLLName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void Interface_ClearCache();
        ...
        [DllImport(DLLName, CallingConvention = CallingConvention.Cdecl)]
        public static extern int Interface_GetStatCount();
        [DllImport(DLLName, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool Interface_GetStatName(int idx, StringBuilder name, int nameSize);
        [DllImport(DLLName, CallingConvention = CallingConvention.Cdecl)]
        public static extern CommonTypes.StatsData Interface_GetStatValue(string name);
        ...
        [DllImport(DLLName, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool Asset_GetCodec(Int32 asset, StringBuilder receivingBuffer, int bufferSize);
        [DllImport(DLLName, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DLLName, CallingConvention = CallingConvention.Cdecl)]
        public static extern float Asset_GetVoxelSize(Int32 asset);
        [DllImport(DLLName, CallingConvention = CallingConvention.Cdecl)]
        public static extern int Asset_GetCurrentBandwidth(Int32 asset);
        [DllImport(DLLName, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool Asset_GetAvailabilityStartTime(Int32 asset, string value, int valueSize);

        public const int ASSET_TYPE_STATIC = 1 << 0;
        public const int ASSET_TYPE_DYNAMIC = 1 << 1;
        [DllImport(DLLName, CallingConvention = CallingConvention.Cdecl)]
        public static extern int Asset_GetType(Int32 asset);
        //-----------------------------------------------------------------------------
