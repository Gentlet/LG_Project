...
namespace HVR.Interface
{
    public static class UnityInterfaceAPI
    {
        ...
        public static void Init()
        {
            ...
            string suffix;
            Helper.GetUnityVersion(out majorVersion, out minorVersion, out patchVersion, out suffix);
            RegisterUnityPlugin(majorVersion, minorVersion, patchVersion, suffix);

            SetFunc_InterfaceShutdown(HvrPlayerInterfaceAPI.Interface_Shutdown);
        }

        [DllImport(DLLName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void RegisterUnityPlugin(int major, int minor, int patch, string suffix);
        ...
        [DllImport(DLLName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void Trigger_InterfaceShutdown();
        ...
        /// --------------------------------------------------------------------------------------------------------------------------------------------------
        /// Dummy callback just to prevent the callback address from changing in Unity editor
        /// --------------------------------------------------------------------------------------------------------------------------------------------------
        [DllImport(DLLName, CallingConvention = CallingConvention.Cdecl)]
        [MonoPInvokeCallback(typeof(Types.OnAssetInitialised))]
        public static extern void StaticHandler_OnAssetInitialised(int error, IntPtr userData);

        [DllImport(DLLName, CallingConvention = CallingConvention.Cdecl)]
        [MonoPInvokeCallback(typeof(Types.OnAssetSelectRepresentation))]
        public static extern bool StaticHandler_OnAssetSelectRepresentation(
        ...
        public static extern void StaticHandler_OnAssetRepresentationDataReceived(
                [In] IntPtr mimeType,
                [In] IntPtr codec,
                float startTime,
                [In] IntPtr data,
        ...
        [DllImport(DLLName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void Callback_Set_OnAssetInitialised(Types.OnAssetInitialised callback);

        [DllImport(DLLName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void Callback_Set_OnAssetSelectRepresentation(Types.OnAssetSelectRepresentation callback);

        [DllImport(DLLName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void Callback_Set_OnAssetRepresentationDataReceived(Types.OnAssetRepresentationDataReceived callback);
