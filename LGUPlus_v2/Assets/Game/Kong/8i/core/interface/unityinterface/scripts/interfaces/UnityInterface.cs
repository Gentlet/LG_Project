...
namespace HVR.Interface
{
    ...
    {
        static UnityInterface()
        {
            // NOTE: we need to move UnityInterfaceAPI.Init() out of the static initializer of UnityInterfaceAPI
            // as it will call Unity API which won't be available during the startup process of Unity
            UnityInterfaceAPI.Init();
        }
