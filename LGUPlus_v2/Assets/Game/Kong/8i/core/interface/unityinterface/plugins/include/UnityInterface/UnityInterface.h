...
// --------------------------------------------------------------------------------------------------------------------------------------------------
API_INTERFACE void	RegisterUnityPlugin(int versionMajor, int versionMinor, int versionPatch, const char* versionSuffix);
...
API_INTERFACE void Trigger_InterfaceShutdown();
...
// --------------------------------------------------------------------------------------------------------------------------------------------------
// Asset callbacks workaround
// --------------------------------------------------------------------------------------------------------------------------------------------------
// TODO: better header file management job
...
API_INTERFACE void StaticHandler_OnAssetInitialised(HVRError error, void* userData);
API_INTERFACE bool StaticHandler_OnAssetSelectRepresentation(const HVRAdaptationSet* adaptationSet, uint32_t representationIndex, 
															const HVRRepresentation* representations, uint32_t representationCount, 
															void* userData);
API_INTERFACE void StaticHandler_OnAssetRepresentationDataReceived(const char* mimeType, const char* codec, float startTime, 
																	const uint8_t* data, uint32_t dataSize, void* userData);

API_INTERFACE void Callback_Set_OnAssetInitialised(OnAssetInitialised callback);
API_INTERFACE void Callback_Set_OnAssetSelectRepresentation(OnAssetSelectRepresentation callback);
API_INTERFACE void Callback_Set_OnAssetRepresentationDataReceived(OnAssetRepresentationDataRecieved callback);
