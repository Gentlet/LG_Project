...
namespace HVR.Editor
{
    public class MenuItems : MonoBehaviour
    {
        ...
        [MenuItem("Assets/Create/8i/HvrEncryptionKey", false, 200)]
        static void CreateObject_HvrEncryptionKey(MenuCommand menuCommand)
        {
            ScriptableObjectUtility.CreateAsset<HvrEncryptionKey>();
        }
