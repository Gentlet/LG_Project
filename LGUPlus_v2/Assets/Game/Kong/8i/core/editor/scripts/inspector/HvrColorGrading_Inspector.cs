        ...
        public static class Primaries
        {
            ...
            public static Vector4 DoGUI(Rect area, string title, Vector4 vec, float rgbMin, float rgbMax)
            {
                ...
                EditorGUILayout.BeginHorizontal();
                {
                    ...
                    vec = EditorGUILayout.ColorField(content, vec, false, false, true, GUILayout.MaxWidth(80), GUILayout.MaxHeight(20));
#else
                    ColorPickerHDRConfig hdrConfig = new ColorPickerHDRConfig(rgbMin, rgbMax, 0, 1);
                    vec = EditorGUILayout.ColorField(content, vec, false, false, true, hdrConfig, GUILayout.MaxWidth(80), GUILayout.MaxHeight(20));
#endif
                    GUILayout.FlexibleSpace();
                }
                EditorGUILayout.EndHorizontal();
