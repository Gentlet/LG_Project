        ...
        private static void Update()
        {
            ...
            if (!EditorApplication.isPlaying)
            {
                ...
                foreach (HvrActor actor in actors)
                {
                    ...
                    {
                        // FIXME: find a new way to get notified when a new frame is decoded
                        if (actor.assetInterface.HasNewFrameDecoded())
                        {
                            assetTimeChanged = true;
                        }
                        // if (actor.assetInterface.GetCurrentTime() != actor.assetInterface.GetDecodeTime())
                        //     assetTimeChanged = true;
